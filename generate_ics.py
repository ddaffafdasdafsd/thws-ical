"""
generate_ics.py — läuft via GitHub Actions jede Stunde.
Liest alle Abos aus Supabase, generiert .ics Dateien im Ordner ical/

Benötigte GitHub Secrets:
  SUPABASE_URL              z.B. https://xxxxxx.supabase.co
  SUPABASE_SERVICE_ROLE_KEY  service_role JWT (niemals öffentlich!)
"""
